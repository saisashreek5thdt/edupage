                ...
                <div className="container mx-auto flex px-5 pb-24 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow lg:relative lg:bottom-14 md:w-1/2 lg:pr-36 md:pr-16 flex flex-col md:items-start md:text-left pb-44 md:mb-0 items-center text-center">
                        ...
                        <p className="mb-8 leading-relaxed font-Linotte font-medium text-left">
                            Sand dunes are a low hill-like shaped landforms
                            formed by sand deposits in the deserts. While the
                            wind blows, it lifts and moves sand from one place
                            to another. While it stops blowing, the sand falls
                            and gets deposited in low hill-like systems. Mounds
                            of loose sand grains that are piled up by wind
                            movement are referred to as sand dunes. They're
                            mostly found in deserts.
                        </p>
                        <p className="mb-8 leading-relaxed font-Linotte font-medium text-left">
                            Dunes are found wherever loose sand is windblown: in
                            deserts, on beaches, and even on some eroded and
                            abandoned farm fields in semi-arid regions, along
                            with northwest India and parts of the southwestern
                            USA. Sand dunes develop into all shapes and sizes.
                            Sand dunes stop moving when they become overgrown
                            with vegetation.
                        </p>
                        <p className="mb-8 leading-relaxed font-Linotte font-medium text-left">
                            There are five major dune shapes: crescentic,
                            linear, star, dome, and parabolic. The most common
                            dune form on this planet and on Mars is crescentic.
                            Crescent-fashioned mounds commonly are
                            wider than long.
                        </p>
